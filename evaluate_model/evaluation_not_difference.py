...
def main():
    ...
    for course in courses:
        ...
        metrics = evaluate_not_difference(course, not_d_df, method, first=1, last=10, under_name=under_name)
    ...
    results_df.to_csv("./result/evaluate_not_difference.csv", index=False)
    
    print("Results saved to ./result/evaluate_not_difference.csv")
